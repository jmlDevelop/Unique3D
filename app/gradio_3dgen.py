...
def generate3dv2(preview_img, input_processing, seed, render_video=True, do_refine=True, expansion_weight=0.1, init_type="std"):
    ...
    ret_mesh, video = save_glb_and_video("/root/autodl-tmp/inf_result/tmp/gradio/generated", new_meshes, with_timestamp=True, dist=3.5, fov_in_degrees=2 / 1.35, cam_type="ortho", export_video=render_video)
...
def create_ui(concurrency_id="wkl"):
    with gr.Row():
        ...
        with gr.Column(scale=3):
            ...
            render_video = gr.Checkbox(value=False, visible=True, label="generate video")
    ...
    fullrunv2_btn.click(
        ...
        outputs=[output_mesh, output_video, gr.update(visible="output_video")],
